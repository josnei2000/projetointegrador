...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Registro de pessoas/empresas') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="type" class="col-md-4 col-form-label text-md-end">{{ __('tipo/cargo') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="trading_name" class="col-md-4 col-form-label text-md-end">{{ __('nome comercial') }}</label>

                            <div class="col-md-6">
                                <input id="trading_name" type="text" class="form-control @error('trading_name') is-invalid @enderror" name="trading_name" value="{{ old('trading_name') }}" required autocomplete="trading_name">
                        ...
                        <div class="row mb-3">
                            <label for="company_name" class="col-md-4 col-form-label text-md-end">{{ __('nome da companhia') }}</label>
