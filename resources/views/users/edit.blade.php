...
<h1  title=:)s2>EDIÇÃO DE CADASTRO DE PESSOAS/EMPRESAS</h1>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control is-valid" id="validationServer02" name="password" required>
    <div class="valid-feedback">
    </div>
  </div>
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="email" class="form-control is-invalid" id="validationServer03" aria-describedby="validationServer03Feedback" required>
